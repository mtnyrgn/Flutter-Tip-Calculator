...
class _BillSplitterState extends State<BillSplitter> {
  ...
  Widget build(BuildContext context) {
    Color _purple = _colorFromHex("#6908d6");
    return Scaffold(
      body: Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Text(" \$ ${calculateTotalPerPerson(_percentage, _billAmount, _personCounter)}",style: TextStyle(
                        fontSize: 34.9,
                        fontWeight: FontWeight.bold,
                        color: _purple
                      ),),
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: Text("\$ ${(calculateTotalTip(_billAmount, _personCounter, _percentage)).toStringAsFixed(2)}",style: TextStyle(
                          color:_purple,
                          fontSize: 17.0,
                          fontWeight: FontWeight.bold
                        ),),
